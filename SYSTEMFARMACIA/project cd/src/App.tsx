...
function App() {
  ...
  const { products, categories, isLoading, getProductsByCategory, searchProducts, getLowStockProducts } = useProducts();
  const cart = useCart();
  ...
  const handleCheckout = () => {
    ...
    alert(`Venta procesada exitosamente!\nTotal: ${cart.formatPrice(cart.getCartTotal())}\n\nGracias por su compra.`);
    cart.clearCart();
    setIsCartOpen(false);
  };
          ...
          <div>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900">
                {activeSection === 'productos' ? 'Productos' : 'Punto de Venta'}
              </h2>
